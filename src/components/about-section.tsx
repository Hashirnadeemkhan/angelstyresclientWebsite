      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-16 relative z-10">
        <div ref={sectionRef} className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div
              className={`absolute bottom-4 left-4 bg-black/90 backdrop-blur-sm text-white p-4 rounded-lg shadow-lg transform transition-all duration-700 delay-500 hover:scale-105 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-xs text-gray-300">Call for Assistance</div>
                  <div className="font-bold text-lg">7476 306677</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6">
              <div
                className={`flex items-center space-x-4 p-4 bg-black/70 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 ${
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-white">24/7 Tyre Support</h4>
                  <p className="text-sm text-gray-300">Emergency Service</p>
                </div>
              </div>

              <div
                className={`flex items-center space-x-4 p-4 bg-black/70 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 delay-100 ${
                  isVisible ? "animate-fade-in-up" : ""
                }`}
              >
                <div className="p-3 bg-red-600 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">Trusted Experts</p>
                </div>
              </div>
            </div>
