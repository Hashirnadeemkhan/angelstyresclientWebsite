...
export function ServicesSection() {
  ...
  return (
    <section id="services" ref={sectionRef} className="py-20 bg-black overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12 xl:px-16">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="flex gap-1">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="w-2 h-2 bg-red-700 rotate-45"></div>
              ))}
            </div>
            <span className="text-gray-300 font-medium tracking-wider">Our Service</span>
            <div className="flex gap-1">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="w-2 h-2 bg-red-700 rotate-45"></div>
              ))}
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            ...
            <span className="block text-red-700">Services to You</span>
          </h2>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-4 text-black group-hover:text-red-700 transition-colors duration-300">
                    {service.title}
                  </h3>
